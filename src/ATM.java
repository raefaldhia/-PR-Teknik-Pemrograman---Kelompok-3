public class ATM {
    ...
    private static final int DISPENSER_INQUIRY = 8;
    ...
    private int displayMainMenu() {
        ...
        if (bankDatabase.isAdmin(currentAccountNumber)) {
            screen.displayMessageLine("\nAdmin Menu:");
            screen.displayMessageLine("7 - Unblock Account");
            screen.displayMessageLine("8 - View cash in dispenser");
            screen.displayMessageLine("9 - Add cash to dispenser");
        }
